...
void tca9555_driver_init(void)
{
    ...
    if (ret == ESP_OK) {
        /* Only configure PA EN (8) and Camera pins (5, 6) */
        esp_io_expander_set_dir(io_expander, IO_EXPANDER_PIN_NUM_8 | IO_EXPANDER_PIN_NUM_6 | IO_EXPANDER_PIN_NUM_5, IO_EXPANDER_OUTPUT);
    }
}
