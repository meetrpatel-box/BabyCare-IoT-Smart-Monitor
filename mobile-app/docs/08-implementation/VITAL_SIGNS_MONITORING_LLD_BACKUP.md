...
**Feature:** Real-time Vital Signs Monitoring (Heart Rate, SpO2, Temperature, Breath Rate)  
**Hardware:** ESP32 + MAX30102 (Heart Rate/SpO2) + MLX90614 (Temperature) + Breath Detection Sensor
...
|------------|--------|-------|------------------|------------------|
| **Heart Rate** | MAX30102 | 60-220 BPM | Every 5 seconds | <80 or >220 BPM |
| **SpO2** | MAX30102 | 85-100% | Every 5 seconds | <92% |
| **Body Temp** | MLX90614 (IR) | 35-39°C | Every 10 seconds | <36.5°C or >38°C |
| **Breath Rate** | Pressure/Motion | 20-60 BPM | Every 10 seconds | <20 or >60 BPM |
